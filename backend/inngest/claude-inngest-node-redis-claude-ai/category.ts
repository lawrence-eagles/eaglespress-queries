...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  Technology: ["ai", "tech", "software", "startup", "mobile", "cyber", "digital", "app", "robot"],
  Business:   ["market", "finance", "economy", "stock", "trade", "gdp", "inflation", "investment"],
  Politics:   ["election", "government", "policy", "president", "parliament", "senate", "congress", "vote"],
  Health:     ["covid", "health", "medicine", "hospital", "vaccine", "disease", "mental health", "fda"],
  Sports:     ["football", "soccer", "nba", "nfl", "tennis", "cricket", "olympic", "championship"],
  Science:    ["nasa", "space", "research", "climate", "environment", "study", "scientist", "discovery"],
  World:      ["war", "conflict", "international", "united nations", "diplomacy", "sanctions"],
}
